...
This Solidity program is a simple program that uses the Solidity programming language to demonstrate some smart contract functionalities and display their results on the frontend using Next JS and Ethers JS. This project creates a simple contract with 2-3 functions and shows their values in the frontend of this application.
